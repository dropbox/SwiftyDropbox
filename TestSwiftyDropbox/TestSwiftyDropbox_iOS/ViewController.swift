...
class ViewController: UIViewController {
    ...
    @IBOutlet var codeFlowlinkButton: UIButton!
    @IBOutlet var unlinkButton: UIButton!
    @IBOutlet var debugBackgroundSessionButton: UIButton!
    ...
    @IBAction func debugBackgroundSessionButtonPressed(_ sender: Any) {
        if #available(iOS 16.0, *) {
            presentBackgroundDebugView()
        }
    }

    @available(iOS 16.0, *)
    private func presentBackgroundDebugView() {
        let contentView = DebugBackgroundSession(debugLogFileURL: BackgroundTestLogger.logsFileURL)
