    ...
    */
    public class DeviceSession: CustomStringConvertible {
        ...
        public init(sessionId: String, ipAddress: String? = nil, country: String? = nil, created: NSDate? = nil, updated: NSDate? = nil) {
            ...
            nullableValidator(stringValidator())(value: ipAddress)
            self.ipAddress = ipAddress
            nullableValidator(stringValidator())(value: country)
    ...
    */
    public class ActiveWebSession: Team.DeviceSession {
        ...
        public init(sessionId: String, userAgent: String, os: String, browser: String, ipAddress: String? = nil, country: String? = nil, created: NSDate? = nil, updated: NSDate? = nil) {
            stringValidator()(value: userAgent)
            self.userAgent = userAgent
            stringValidator()(value: os)
            self.os = os
            stringValidator()(value: browser)
    ...
    */
    public class AddPropertyTemplateResult: CustomStringConvertible {
        ...
        public init(templateId: String) {
            stringValidator(minLength: 1, pattern: "(/|ptid:).*")(value: templateId)
    ...
    */
    public class AlphaGroupFullInfo: TeamCommon.AlphaGroupSummary {
        ...
        public init(groupName: String, groupId: String, groupManagementType: TeamCommon.GroupManagementType, created: UInt64, groupExternalId: String? = nil, memberCount: UInt32? = nil, members: Array<Team.GroupMemberInfo>? = nil) {
            ...
            comparableValidator()(value: created)
            self.created = created
    ...
    */
    public class GroupUpdateArgs: Team.IncludeMembersArg {
        ...
        public init(group: Team.GroupSelector, returnMembers: Bool = true, newGroupName: String? = nil, newGroupExternalId: String? = nil) {
            self.group = group
            nullableValidator(stringValidator())(value: newGroupName)
            self.newGroupName = newGroupName
            nullableValidator(stringValidator())(value: newGroupExternalId)
    ...
    */
    public class ApiApp: CustomStringConvertible {
        ...
        public init(appId: String, appName: String, isAppFolder: Bool, publisher: String? = nil, publisherUrl: String? = nil, linked: NSDate? = nil) {
            stringValidator()(value: appId)
            self.appId = appId
            stringValidator()(value: appName)
            self.appName = appName
            nullableValidator(stringValidator())(value: publisher)
            self.publisher = publisher
            nullableValidator(stringValidator())(value: publisherUrl)
    ...
    */
    public class BaseDfbReport: CustomStringConvertible {
        ...
        public init(startDate: String) {
            stringValidator()(value: startDate)
    ...
    */
    public class DesktopClientSession: Team.DeviceSession {
        ...
        public init(sessionId: String, hostName: String, clientType: Team.DesktopPlatform, clientVersion: String, platform: String, isDeleteOnUnlinkSupported: Bool, ipAddress: String? = nil, country: String? = nil, created: NSDate? = nil, updated: NSDate? = nil) {
            stringValidator()(value: hostName)
            self.hostName = hostName
            self.clientType = clientType
            stringValidator()(value: clientVersion)
            self.clientVersion = clientVersion
            stringValidator()(value: platform)
    ...
    */
    public class DeviceSessionArg: CustomStringConvertible {
        ...
        public init(sessionId: String, teamMemberId: String) {
            stringValidator()(value: sessionId)
            self.sessionId = sessionId
            stringValidator()(value: teamMemberId)
    ...
    */
    public class DevicesActive: CustomStringConvertible {
        ...
        public init(windows: Array<UInt64?>, macos: Array<UInt64?>, linux: Array<UInt64?>, ios: Array<UInt64?>, android: Array<UInt64?>, other: Array<UInt64?>, total: Array<UInt64?>) {
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: windows)
            self.windows = windows
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: macos)
            self.macos = macos
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: linux)
            self.linux = linux
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: ios)
            self.ios = ios
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: android)
            self.android = android
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: other)
            self.other = other
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: total)
            self.total = total
        }
        public var description: String {
    ...
    */
    public class GetActivityReport: Team.BaseDfbReport {
        ...
        public init(startDate: String, adds: Array<UInt64?>, edits: Array<UInt64?>, deletes: Array<UInt64?>, activeUsers28Day: Array<UInt64?>, activeUsers7Day: Array<UInt64?>, activeUsers1Day: Array<UInt64?>, activeSharedFolders28Day: Array<UInt64?>, activeSharedFolders7Day: Array<UInt64?>, activeSharedFolders1Day: Array<UInt64?>, sharedLinksCreated: Array<UInt64?>, sharedLinksViewedByTeam: Array<UInt64?>, sharedLinksViewedByOutsideUser: Array<UInt64?>, sharedLinksViewedByNotLoggedIn: Array<UInt64?>, sharedLinksViewedTotal: Array<UInt64?>) {
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: adds)
            self.adds = adds
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: edits)
            self.edits = edits
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: deletes)
            self.deletes = deletes
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: activeUsers28Day)
            self.activeUsers28Day = activeUsers28Day
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: activeUsers7Day)
            self.activeUsers7Day = activeUsers7Day
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: activeUsers1Day)
            self.activeUsers1Day = activeUsers1Day
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: activeSharedFolders28Day)
            self.activeSharedFolders28Day = activeSharedFolders28Day
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: activeSharedFolders7Day)
            self.activeSharedFolders7Day = activeSharedFolders7Day
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: activeSharedFolders1Day)
            self.activeSharedFolders1Day = activeSharedFolders1Day
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: sharedLinksCreated)
            self.sharedLinksCreated = sharedLinksCreated
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: sharedLinksViewedByTeam)
            self.sharedLinksViewedByTeam = sharedLinksViewedByTeam
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: sharedLinksViewedByOutsideUser)
            self.sharedLinksViewedByOutsideUser = sharedLinksViewedByOutsideUser
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: sharedLinksViewedByNotLoggedIn)
            self.sharedLinksViewedByNotLoggedIn = sharedLinksViewedByNotLoggedIn
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: sharedLinksViewedTotal)
    ...
    */
    public class GetMembershipReport: Team.BaseDfbReport {
        ...
        public init(startDate: String, teamSize: Array<UInt64?>, pendingInvites: Array<UInt64?>, membersJoined: Array<UInt64?>, suspendedMembers: Array<UInt64?>, licenses: Array<UInt64?>) {
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: teamSize)
            self.teamSize = teamSize
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: pendingInvites)
            self.pendingInvites = pendingInvites
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: membersJoined)
            self.membersJoined = membersJoined
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: suspendedMembers)
            self.suspendedMembers = suspendedMembers
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: licenses)
    ...
    */
    public class GetStorageReport: Team.BaseDfbReport {
        ...
        public init(startDate: String, totalUsage: Array<UInt64?>, sharedUsage: Array<UInt64?>, unsharedUsage: Array<UInt64?>, sharedFolders: Array<UInt64?>, memberStorageMap: Array<Array<Team.StorageBucket>>) {
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: totalUsage)
            self.totalUsage = totalUsage
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: sharedUsage)
            self.sharedUsage = sharedUsage
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: unsharedUsage)
            self.unsharedUsage = unsharedUsage
            arrayValidator(itemValidator: nullableValidator(comparableValidator()))(value: sharedFolders)
    ...
    */
    public class GroupsListArg: CustomStringConvertible {
        ...
        public init(limit: UInt32 = 1000) {
            comparableValidator(minValue: 1, maxValue: 1000)(value: limit)
            self.limit = limit
        }
        public var description: String {
    ...
    */
    public class MemberAddArg: CustomStringConvertible {
        ...
        public init(memberEmail: String, memberGivenName: String, memberSurname: String, memberExternalId: String? = nil, sendWelcomeEmail: Bool = true, role: Team.AdminTier = .MemberOnly) {
            stringValidator(maxLength: 255, pattern: "^['&A-Za-z0-9._%+-]+@[A-Za-z0-9-][A-Za-z0-9.-]*.[A-Za-z]{2,15}$")(value: memberEmail)
            self.memberEmail = memberEmail
            stringValidator(minLength: 1, maxLength: 100, pattern: "[^/:?*<>\"|]*")(value: memberGivenName)
            self.memberGivenName = memberGivenName
            stringValidator(minLength: 1, maxLength: 100, pattern: "[^/:?*<>\"|]*")(value: memberSurname)
            self.memberSurname = memberSurname
            nullableValidator(stringValidator(maxLength: 64))(value: memberExternalId)
    ...
    */
    public class MemberProfile: CustomStringConvertible {
        ...
        public init(teamMemberId: String, email: String, emailVerified: Bool, status: Team.TeamMemberStatus, name: Users.Name, membershipType: Team.TeamMembershipType, externalId: String? = nil, accountId: String? = nil) {
            stringValidator()(value: teamMemberId)
            self.teamMemberId = teamMemberId
            nullableValidator(stringValidator())(value: externalId)
            self.externalId = externalId
            nullableValidator(stringValidator(minLength: 40, maxLength: 40))(value: accountId)
    ...
    */
    public class MembersSetProfileArg: CustomStringConvertible {
        ...
        public init(user: Team.UserSelectorArg, newEmail: String? = nil, newExternalId: String? = nil, newGivenName: String? = nil, newSurname: String? = nil) {
            self.user = user
            nullableValidator(stringValidator(maxLength: 255, pattern: "^['&A-Za-z0-9._%+-]+@[A-Za-z0-9-][A-Za-z0-9.-]*.[A-Za-z]{2,15}$"))(value: newEmail)
            self.newEmail = newEmail
            nullableValidator(stringValidator(maxLength: 64))(value: newExternalId)
            self.newExternalId = newExternalId
            nullableValidator(stringValidator(minLength: 1, maxLength: 100, pattern: "[^/:?*<>\"|]*"))(value: newGivenName)
            self.newGivenName = newGivenName
            nullableValidator(stringValidator(minLength: 1, maxLength: 100, pattern: "[^/:?*<>\"|]*"))(value: newSurname)
    ...
    */
    public class MobileClientSession: Team.DeviceSession {
        ...
        public init(sessionId: String, deviceName: String, clientType: Team.MobileClientPlatform, ipAddress: String? = nil, country: String? = nil, created: NSDate? = nil, updated: NSDate? = nil, clientVersion: String? = nil, osVersion: String? = nil, lastCarrier: String? = nil) {
            stringValidator()(value: deviceName)
            self.deviceName = deviceName
            self.clientType = clientType
            nullableValidator(stringValidator())(value: clientVersion)
            self.clientVersion = clientVersion
            nullableValidator(stringValidator())(value: osVersion)
            self.osVersion = osVersion
            nullableValidator(stringValidator())(value: lastCarrier)
    ...
    */
    public class StorageBucket: CustomStringConvertible {
        ...
        public init(bucket: String, users: UInt64) {
            stringValidator()(value: bucket)
            self.bucket = bucket
            comparableValidator()(value: users)
            self.users = users
        }
        public var description: String {
    ...
    */
    public class TeamGetInfoResult: CustomStringConvertible {
        ...
        public init(name: String, teamId: String, numLicensedUsers: UInt32, numProvisionedUsers: UInt32, policies: TeamPolicies.TeamMemberPolicies) {
            ...
            self.name = name
            stringValidator()(value: teamId)
            self.teamId = teamId
            comparableValidator()(value: numLicensedUsers)
            self.numLicensedUsers = numLicensedUsers
            comparableValidator()(value: numProvisionedUsers)
    ...
    */
    public class TeamMemberProfile: Team.MemberProfile {
        ...
        public init(teamMemberId: String, email: String, emailVerified: Bool, status: Team.TeamMemberStatus, name: Users.Name, membershipType: Team.TeamMembershipType, groups: Array<String>, externalId: String? = nil, accountId: String? = nil) {
            arrayValidator(itemValidator: stringValidator())(value: groups)
            self.groups = groups
    ...
    */
    public class UpdatePropertyTemplateArg: CustomStringConvertible {
        ...
        public init(templateId: String, name: String? = nil, description_: String? = nil, addFields: Array<Properties.PropertyFieldTemplate>? = nil) {
            stringValidator(minLength: 1, pattern: "(/|ptid:).*")(value: templateId)
            self.templateId = templateId
            nullableValidator(stringValidator())(value: name)
            self.name = name
            nullableValidator(stringValidator())(value: description_)
