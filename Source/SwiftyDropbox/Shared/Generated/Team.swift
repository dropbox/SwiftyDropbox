...
public class Team {
    ...
    public class ExcludedUsersListArgSerializer: JSONSerializer {
        ...
        public func deserialize(_ json: JSON) throws -> ExcludedUsersListArg {
            switch json {
                case .dictionary(let dict):
                    let limit = try Serialization._UInt32Serializer.deserialize(dict["limit"] ?? .number(1000))
    ...
    public class GetActivityReportSerializer: JSONSerializer {
        ...
        public func serialize(_ value: GetActivityReport) throws -> JSON {
            ...
            "active_shared_folders_28_day": try ArraySerializer(NullableSerializer(Serialization._UInt64Serializer)).serialize(value.activeSharedFolders28Day),
            ...
            "shared_links_viewed_by_outside_user": try ArraySerializer(NullableSerializer(Serialization._UInt64Serializer)).serialize(value.sharedLinksViewedByOutsideUser),
            "shared_links_viewed_by_not_logged_in": try ArraySerializer(NullableSerializer(Serialization._UInt64Serializer)).serialize(value.sharedLinksViewedByNotLoggedIn),
        ...
        public func deserialize(_ json: JSON) throws -> GetActivityReport {
            switch json {
                case .dictionary(let dict):
                    ...
                    let activeSharedFolders28Day = try ArraySerializer(NullableSerializer(Serialization._UInt64Serializer)).deserialize(dict["active_shared_folders_28_day"] ?? .null)
                    let activeSharedFolders7Day = try ArraySerializer(NullableSerializer(Serialization._UInt64Serializer)).deserialize(dict["active_shared_folders_7_day"] ?? .null)
                    let activeSharedFolders1Day = try ArraySerializer(NullableSerializer(Serialization._UInt64Serializer)).deserialize(dict["active_shared_folders_1_day"] ?? .null)
                    let sharedLinksCreated = try ArraySerializer(NullableSerializer(Serialization._UInt64Serializer)).deserialize(dict["shared_links_created"] ?? .null)
                    let sharedLinksViewedByTeam = try ArraySerializer(NullableSerializer(Serialization._UInt64Serializer)).deserialize(dict["shared_links_viewed_by_team"] ?? .null)
                    let sharedLinksViewedByOutsideUser = try ArraySerializer(NullableSerializer(Serialization._UInt64Serializer)).deserialize(dict["shared_links_viewed_by_outside_user"] ?? .null)
                    let sharedLinksViewedByNotLoggedIn = try ArraySerializer(NullableSerializer(Serialization._UInt64Serializer)).deserialize(dict["shared_links_viewed_by_not_logged_in"] ?? .null)
                    let sharedLinksViewedTotal = try ArraySerializer(NullableSerializer(Serialization._UInt64Serializer)).deserialize(dict["shared_links_viewed_total"] ?? .null)
        ...
        public func deserialize(_ json: JSON) throws -> GroupUpdateArgs {
            switch json {
                case .dictionary(let dict):
                    ...
                    let newGroupManagementType = try NullableSerializer(TeamCommon.GroupManagementTypeSerializer()).deserialize(dict["new_group_management_type"] ?? .null)
    ...
    public class ListMemberDevicesResultSerializer: JSONSerializer {
        ...
        public func deserialize(_ json: JSON) throws -> ListMemberDevicesResult {
            switch json {
                case .dictionary(let dict):
                    let activeWebSessions = try NullableSerializer(ArraySerializer(Team.ActiveWebSessionSerializer())).deserialize(dict["active_web_sessions"] ?? .null)
                    let desktopClientSessions = try NullableSerializer(ArraySerializer(Team.DesktopClientSessionSerializer())).deserialize(dict["desktop_client_sessions"] ?? .null)
                    let mobileClientSessions = try NullableSerializer(ArraySerializer(Team.MobileClientSessionSerializer())).deserialize(dict["mobile_client_sessions"] ?? .null)
        ...
        public func deserialize(_ json: JSON) throws -> MemberProfile {
            switch json {
                case .dictionary(let dict):
                    ...
                    let secondaryEmails = try NullableSerializer(ArraySerializer(SecondaryEmails.SecondaryEmailSerializer())).deserialize(dict["secondary_emails"] ?? .null)
    ...
    public class MembersRemoveArg: Team.MembersDeactivateArg {
        ...
        public init(user: Team.UserSelectorArg, wipeData: Bool = true, transferDestId: Team.UserSelectorArg? = nil, transferAdminId: Team.UserSelectorArg? = nil, keepAccount: Bool = false, retainTeamShares: Bool = false, permanentlyDeleteFiles: Bool = false) {
            self.transferDestId = transferDestId
            self.transferAdminId = transferAdminId
        ...
        public func deserialize(_ json: JSON) throws -> MembersRemoveArg {
            switch json {
                case .dictionary(let dict):
                    ...
                    return MembersRemoveArg(user: user, wipeData: wipeData, transferDestId: transferDestId, transferAdminId: transferAdminId, keepAccount: keepAccount, retainTeamShares: retainTeamShares, permanentlyDeleteFiles: permanentlyDeleteFiles)
                default:
    ...
    public class TeamFolderMetadata: CustomStringConvertible, JSONRepresentable {
        ...
        public let quotaLimit: Int64
        public init(teamFolderId: String, name: String, status: Team.TeamFolderStatus, isTeamSharedDropbox: Bool, syncSetting: Files.SyncSetting, contentSyncSettings: Array<Files.ContentSyncSetting>, quotaLimit: Int64 = 0) {
            stringValidator(pattern: "[-_0-9a-zA-Z:]+")(teamFolderId)
            self.teamFolderId = teamFolderId
            stringValidator()(name)
            self.name = name
        ...
        public func deserialize(_ json: JSON) throws -> TeamFolderMetadata {
            switch json {
                case .dictionary(let dict):
                    ...
                    let quotaLimit = try Serialization._Int64Serializer.deserialize(dict["quota_limit"] ?? .number(0))
                    return TeamFolderMetadata(teamFolderId: teamFolderId, name: name, status: status, isTeamSharedDropbox: isTeamSharedDropbox, syncSetting: syncSetting, contentSyncSettings: contentSyncSettings, quotaLimit: quotaLimit)
                default:
        ...
        public func deserialize(_ json: JSON) throws -> TeamFolderUpdateSyncSettingsArg {
            switch json {
                case .dictionary(let dict):
                    let teamFolderId = try Serialization._StringSerializer.deserialize(dict["team_folder_id"] ?? .null)
                    let syncSetting = try NullableSerializer(Files.SyncSettingArgSerializer()).deserialize(dict["sync_setting"] ?? .null)
                    let contentSyncSettings = try NullableSerializer(ArraySerializer(Files.ContentSyncSettingArgSerializer())).deserialize(dict["content_sync_settings"] ?? .null)
    ...
    public class TeamGetInfoResult: CustomStringConvertible, JSONRepresentable {
        ...
        public init(name: String, teamId: String, numLicensedUsers: UInt32, numProvisionedUsers: UInt32, policies: TeamPolicies.TeamMemberPolicies, numUsedLicenses: UInt32 = 0) {
            stringValidator()(name)
            self.name = name
        ...
        public func deserialize(_ json: JSON) throws -> TeamGetInfoResult {
            switch json {
                case .dictionary(let dict):
                    ...
                    return TeamGetInfoResult(name: name, teamId: teamId, numLicensedUsers: numLicensedUsers, numProvisionedUsers: numProvisionedUsers, policies: policies, numUsedLicenses: numUsedLicenses)
                default:
        ...
        public func deserialize(_ json: JSON) throws -> TeamMemberProfile {
            switch json {
                case .dictionary(let dict):
                    ...
                    let isDirectoryRestricted = try NullableSerializer(Serialization._BoolSerializer).deserialize(dict["is_directory_restricted"] ?? .null)
                    let profilePhotoUrl = try NullableSerializer(Serialization._StringSerializer).deserialize(dict["profile_photo_url"] ?? .null)
                    return TeamMemberProfile(teamMemberId: teamMemberId, email: email, emailVerified: emailVerified, status: status, name: name, membershipType: membershipType, groups: groups, memberFolderId: memberFolderId, rootFolderId: rootFolderId, externalId: externalId, accountId: accountId, secondaryEmails: secondaryEmails, invitedOn: invitedOn, joinedOn: joinedOn, suspendedOn: suspendedOn, persistentId: persistentId, isDirectoryRestricted: isDirectoryRestricted, profilePhotoUrl: profilePhotoUrl)
                default:
    ...
    static let devicesListMemberDevices = Route(
        ...
        attributes: RouteAttributes(auth: [.team],
                                    host: .api,
                                    style: .rpc)
    )
