...
public class SharingRoutes: DropboxTransportClientOwning {
    ...
    @discardableResult public func addFolderMember(
        ...
        let serverArgs = Sharing.AddFolderMemberArg(
    ...
    @discardableResult public func checkRemoveMemberJobStatus(asyncJobId: String) -> RpcRequest<
        Sharing.RemoveMemberJobStatusSerializer,
    ...
    /// app needs to revoke a shared link, use revoke_shared_link. DEPRECATED: Use create_shared_link_with_settings
    /// instead.
    ///
    /// - scope: sharing.write
    ///
    /// - parameter path: The path to share.
    /// - parameter shortUrl: Field is deprecated. None
    ...
    @available(*, unavailable, message: "createSharedLink is deprecated.")
    @discardableResult public func createSharedLink(path: String, shortUrl: Bool = false, pendingUpload: Sharing.PendingUploadMode? = nil) -> RpcRequest<
        Sharing.PathLinkMetadataSerializer,
        Sharing.CreateSharedLinkErrorSerializer
    > {
    ...
    @discardableResult public func createSharedLinkWithSettings(path: String, settings: Sharing.SharedLinkSettings? = nil) -> RpcRequest<
        Sharing.SharedLinkMetadataSerializer,
        Sharing.CreateSharedLinkWithSettingsErrorSerializer
    > {
    ...
    @discardableResult public func getFileMetadata(file: String, actions: [Sharing.FileAction]? = nil) -> RpcRequest<
        Sharing.SharedFileMetadataSerializer,
        Sharing.GetFileMetadataErrorSerializer
    > {
    ...
    @discardableResult public func getFileMetadataBatch(files: [String], actions: [Sharing.FileAction]? = nil) -> RpcRequest<
        ArraySerializer<Sharing.GetFileMetadataBatchResultSerializer>,
        Sharing.SharingUserErrorSerializer
    > {
    ...
    @discardableResult public func getFolderMetadata(sharedFolderId: String, actions: [Sharing.FolderAction]? = nil) -> RpcRequest<
        Sharing.SharedFolderMetadataSerializer,
        Sharing.SharedFolderAccessErrorSerializer
    > {
    ...
    /// DEPRECATED: Use list_shared_links instead. This endpoint will be retired in October 2026. Returns a list of
    /// LinkMetadata objects for this user, including collection links. If no path is given, returns a list of all
    /// shared links for the current user, including collection links, up to a maximum of 1000 links. If a non-empty
    /// path is given, returns a list of all shared links that allow access to the given path. Collection links are
    ...
    @available(*, unavailable, message: "getSharedLinks is deprecated.")
    @discardableResult public func getSharedLinks(path: String? = nil) -> RpcRequest<
        Sharing.GetSharedLinksResultSerializer,
        Sharing.GetSharedLinksErrorSerializer
    > {
    ...
    @discardableResult public func listFileMembers(file: String, actions: [Sharing.MemberAction]? = nil, includeInherited: Bool = true, limit: UInt32 = 100) -> RpcRequest<
        Sharing.SharedFileMembersSerializer,
        Sharing.ListFileMembersErrorSerializer
    > {
    ...
    /// object on success or a `Sharing.SharingUserError` object on failure.
    @discardableResult public func listFileMembersBatch(files: [String], limit: UInt32 = 1_000) -> RpcRequest<
        ArraySerializer<Sharing.ListFileMembersBatchResultSerializer>,
        Sharing.SharingUserErrorSerializer
    > {
    ...
    @discardableResult public func listFileMembersContinue(cursor: String) -> RpcRequest<
        Sharing.SharedFileMembersSerializer,
        Sharing.ListFileMembersContinueErrorSerializer
    > {
    ...
    /// success or a `Sharing.SharedFolderAccessError` object on failure.
    @discardableResult public func listFolderMembers(sharedFolderId: String, actions: [Sharing.MemberAction]? = nil, limit: UInt32 = 1_000, path: String? = nil) -> RpcRequest<
        Sharing.SharedFolderMembersSerializer,
        Sharing.SharedFolderAccessErrorSerializer
    > {
        let route = Sharing.listFolderMembers
        let serverArgs = Sharing.ListFolderMembersArgs(sharedFolderId: sharedFolderId, actions: actions, limit: limit, path: path)
        return client.request(route, serverArgs: serverArgs)
    }
    ...
    @discardableResult public func listFolderMembersContinue(cursor: String) -> RpcRequest<
        Sharing.SharedFolderMembersSerializer,
        Sharing.ListFolderMembersContinueErrorSerializer
    > {
    ...
    @discardableResult public func listFolders(limit: UInt32 = 1_000, actions: [Sharing.FolderAction]? = nil) -> RpcRequest<
        Sharing.ListFoldersResultSerializer,
        VoidSerializer
    > {
    ...
    @discardableResult public func listFoldersContinue(cursor: String) -> RpcRequest<
        Sharing.ListFoldersResultSerializer,
        Sharing.ListFoldersContinueErrorSerializer
    > {
    ...
    /// - returns: Through the response callback, the caller will receive a `Sharing.ListFoldersResult` object on
    /// success or a `Void` object on failure.
    @discardableResult public func listMountableFolders(limit: UInt32 = 1_000, actions: [Sharing.FolderAction]? = nil) -> RpcRequest<
        Sharing.ListFoldersResultSerializer,
        VoidSerializer
    > {
    ...
    /// - returns: Through the response callback, the caller will receive a `Sharing.ListFoldersResult` object on
    /// success or a `Sharing.ListFoldersContinueError` object on failure.
    @discardableResult public func listMountableFoldersContinue(cursor: String) -> RpcRequest<
        Sharing.ListFoldersResultSerializer,
        Sharing.ListFoldersContinueErrorSerializer
    > {
    ...
    @discardableResult public func listReceivedFiles(limit: UInt32 = 100, actions: [Sharing.FileAction]? = nil) -> RpcRequest<
        Sharing.ListFilesResultSerializer,
        Sharing.SharingUserErrorSerializer
    > {
    ...
    @discardableResult public func listReceivedFilesContinue(cursor: String) -> RpcRequest<
        Sharing.ListFilesResultSerializer,
        Sharing.ListFilesContinueErrorSerializer
    > {
    ...
    @discardableResult public func listSharedLinks(path: String? = nil, cursor: String? = nil, directOnly: Bool? = nil) -> RpcRequest<
        Sharing.ListSharedLinksResultSerializer,
        Sharing.ListSharedLinksErrorSerializer
    > {
    ...
    @discardableResult public func modifySharedLinkSettings(url: String, settings: Sharing.SharedLinkSettings, removeExpiration: Bool = false) -> RpcRequest<
        Sharing.SharedLinkMetadataSerializer,
        Sharing.ModifySharedLinkSettingsErrorSerializer
    > {
    ...
    @discardableResult public func relinquishAccess(fileId: String) -> RpcRequest<
        Sharing.RelinquishAccessResultSerializer,
        Sharing.RelinquishAccessErrorSerializer
    > {
        let route = Sharing.relinquishAccess
        let serverArgs = Sharing.RelinquishAccessArg(fileId: fileId)
        return client.request(route, serverArgs: serverArgs)
    }
    ...
    @discardableResult public func relinquishFolderMembership(sharedFolderId: String, leaveACopy: Bool = false) -> RpcRequest<
        Async.LaunchEmptyResultSerializer,
        Sharing.RelinquishFolderMembershipErrorSerializer
    > {
    ...
    @available(*, unavailable, message: "removeFileMember is deprecated.")
    @discardableResult public func removeFileMember(file: String, member: Sharing.MemberSelector) -> RpcRequest<
        Sharing.FileMemberActionIndividualResultSerializer,
        Sharing.RemoveFileMemberErrorSerializer
    > {
    ...
    /// object on success or a `Sharing.RemoveFileMemberError` object on failure.
    @discardableResult public func removeFileMember2(file: String, member: Sharing.MemberSelector) -> RpcRequest<
        Sharing.FileMemberRemoveActionResultSerializer,
        Sharing.RemoveFileMemberErrorSerializer
    > {
    ...
    @discardableResult public func removeFolderMember(sharedFolderId: String, member: Sharing.MemberSelector, leaveACopy: Bool) -> RpcRequest<
        Async.LaunchResultBaseSerializer,
        Sharing.RemoveFolderMemberErrorSerializer
    > {
    ...
    @discardableResult public func setAccessInheritance(sharedFolderId: String, accessInheritance: Sharing.AccessInheritance = .inherit) -> RpcRequest<
        Sharing.ShareFolderLaunchSerializer,
        Sharing.SetAccessInheritanceErrorSerializer
    > {
    ...
    @discardableResult public func transferFolder(sharedFolderId: String, toDropboxId: String) -> RpcRequest<
        VoidSerializer,
        Sharing.TransferFolderErrorSerializer
    > {
    ...
    @discardableResult public func unshareFolder(sharedFolderId: String, leaveACopy: Bool = false) -> RpcRequest<
        Async.LaunchEmptyResultSerializer,
        Sharing.UnshareFolderErrorSerializer
    > {
    ...
    @discardableResult public func updateFileMember(file: String, member: Sharing.MemberSelector, accessLevel: Sharing.AccessLevel) -> RpcRequest<
        Sharing.MemberAccessLevelResultSerializer,
        Sharing.FileMemberActionErrorSerializer
    > {
    ...
    @discardableResult public func updateFilePolicy(
        file: String,
        actions: [Sharing.FileAction]? = nil,
        linkSettings: Sharing.LinkSettings? = nil,
        viewerInfoPolicy: Sharing.ViewerInfoPolicy? = nil
    ) -> RpcRequest<Sharing.SharedFileMetadataSerializer, Sharing.UpdateFilePolicyErrorSerializer> {
        let route = Sharing.updateFilePolicy
        let serverArgs = Sharing.UpdateFilePolicyArg(file: file, actions: actions, linkSettings: linkSettings, viewerInfoPolicy: viewerInfoPolicy)
        return client.request(route, serverArgs: serverArgs)
    }
    ...
    @discardableResult public func updateFolderMember(sharedFolderId: String, member: Sharing.MemberSelector, accessLevel: Sharing.AccessLevel) -> RpcRequest<
        Sharing.MemberAccessLevelResultSerializer,
        Sharing.UpdateFolderMemberErrorSerializer
    > {
