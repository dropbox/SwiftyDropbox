...
public class FilesRoutes: DropboxTransportClientOwning {
    ...
    /// success or a `Void` object on failure.
    @discardableResult public func copyBatchV2(entries: [Files.RelocationPath], autorename: Bool = false) -> RpcRequest<
        Files.RelocationBatchV2LaunchSerializer,
        VoidSerializer
    > {
    ...
    @discardableResult public func copyReferenceSave(copyReference: String, path: String) -> RpcRequest<
        Files.SaveCopyReferenceResultSerializer,
        Files.SaveCopyReferenceErrorSerializer
    > {
    ...
    @discardableResult public func createFolder(path: String, autorename: Bool = false) -> RpcRequest<
        Files.FolderMetadataSerializer,
        Files.CreateFolderErrorSerializer
    > {
    ...
    @discardableResult public func createFolderV2(path: String, autorename: Bool = false) -> RpcRequest<
        Files.CreateFolderResultSerializer,
        Files.CreateFolderErrorSerializer
    > {
    ...
    /// success or a `Void` object on failure.
    @discardableResult public func createFolderBatch(paths: [String], autorename: Bool = false, forceAsync: Bool = false) -> RpcRequest<
        Files.CreateFolderBatchLaunchSerializer,
        VoidSerializer
    > {
    ...
    /// success or a `Async.PollError` object on failure.
    @discardableResult public func createFolderBatchCheck(asyncJobId: String) -> RpcRequest<
        Files.CreateFolderBatchJobStatusSerializer,
    ...
    @discardableResult public func download(path: String, rev: String? = nil, overwrite: Bool = false, destination: URL) -> DownloadRequestFile<
    ...
    /// - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.DownloadError` object on failure.
    @discardableResult public func download(path: String, rev: String? = nil) -> DownloadRequestMemory<
        Files.FileMetadataSerializer,
        Files.DownloadErrorSerializer
    > {
        let route = Files.download
    ...
    @discardableResult public func downloadZip(path: String, overwrite: Bool = false, destination: URL) -> DownloadRequestFile<
        Files.DownloadZipResultSerializer,
        Files.DownloadZipErrorSerializer
    > {
    ...
    @discardableResult public func export(path: String, exportFormat: String? = nil, overwrite: Bool = false, destination: URL) -> DownloadRequestFile<
        Files.ExportResultSerializer,
    ...
    /// - returns: Through the response callback, the caller will receive a `Files.ExportResult` object on success or a
    /// `Files.ExportError` object on failure.
    @discardableResult public func export(path: String, exportFormat: String? = nil) -> DownloadRequestMemory<
        Files.ExportResultSerializer,
        Files.ExportErrorSerializer
    > {
        let route = Files.export
    ...
    @discardableResult public func getFileLockBatch(entries: [Files.LockFileArg]) -> RpcRequest<
        Files.LockFileBatchResultSerializer,
        Files.LockFileErrorSerializer
    > {
    ...
    @discardableResult public func getPreview(path: String, rev: String? = nil, overwrite: Bool = false, destination: URL) -> DownloadRequestFile<
        Files.FileMetadataSerializer,
        Files.PreviewErrorSerializer
    > {
    ...
    /// - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.PreviewError` object on failure.
    @discardableResult public func getPreview(path: String, rev: String? = nil) -> DownloadRequestMemory<
        Files.FileMetadataSerializer,
        Files.PreviewErrorSerializer
    > {
        let route = Files.getPreview
    ...
    @discardableResult public func getTemporaryUploadLink(commitInfo: Files.CommitInfo, duration: Double = 14_400.0) -> RpcRequest<
        Files.GetTemporaryUploadLinkResultSerializer,
        VoidSerializer
    > {
    ...
    @discardableResult public func getThumbnailBatch(entries: [Files.ThumbnailArg]) -> RpcRequest<
        Files.GetThumbnailBatchResultSerializer,
        Files.GetThumbnailBatchErrorSerializer
    > {
    ...
    @discardableResult public func listFolder(
        ...
        includeRestorableInfo: Bool = false
    ...
    @discardableResult public func listFolderLongpoll(cursor: String, timeout: UInt64 = 30) -> RpcRequest<
        Files.ListFolderLongpollResultSerializer,
        Files.ListFolderLongpollErrorSerializer
    > {
    ...
    /// - returns: Through the response callback, the caller will receive a `Files.RelocationBatchV2Launch` object on
    /// success or a `Void` object on failure.
    @discardableResult public func moveBatchV2(entries: [Files.RelocationPath], autorename: Bool = false, allowOwnershipTransfer: Bool = false) -> RpcRequest<
        Files.RelocationBatchV2LaunchSerializer,
        VoidSerializer
    > {
    ...
    @discardableResult public func paperCreate(path: String, importFormat: Files.ImportFormat, input: Data) -> UploadRequest<
        Files.PaperCreateResultSerializer,
        Files.PaperCreateErrorSerializer
    > {
    ...
    /// - returns: Through the response callback, the caller will receive a `Files.PaperCreateResult` object on success
    /// or a `Files.PaperCreateError` object on failure.
    @discardableResult public func paperCreate(path: String, importFormat: Files.ImportFormat, input: URL) -> UploadRequest<
        Files.PaperCreateResultSerializer,
        Files.PaperCreateErrorSerializer
    > {
        let route = Files.paperCreate
    ...
    /// - returns: Through the response callback, the caller will receive a `Files.PaperCreateResult` object on success
    /// or a `Files.PaperCreateError` object on failure.
    @discardableResult public func paperCreate(path: String, importFormat: Files.ImportFormat, input: InputStream) -> UploadRequest<
        Files.PaperCreateResultSerializer,
        Files.PaperCreateErrorSerializer
    > {
        let route = Files.paperCreate
    ...
    @discardableResult public func search(path: String, query: String, start: UInt64 = 0, maxResults: UInt64 = 100, mode: Files.SearchMode = .filename) -> RpcRequest<
        Files.SearchResultSerializer,
        Files.SearchErrorSerializer
    > {
    ...
    /// - returns: Through the response callback, the caller will receive a `Files.LockFileBatchResult` object on
    /// success or a `Files.LockFileError` object on failure.
    @discardableResult public func unlockFileBatch(entries: [Files.UnlockFileArg]) -> RpcRequest<
        Files.LockFileBatchResultSerializer,
        Files.LockFileErrorSerializer
    > {
    ...
    @discardableResult public func uploadSessionAppend(sessionId: String, offset: UInt64, input: Data) -> UploadRequest<
        VoidSerializer,
        Files.UploadSessionAppendErrorSerializer
    > {
    ...
    /// `Files.UploadSessionAppendError` object on failure.
    @available(*, unavailable, message: "uploadSessionAppend is deprecated.")
    @discardableResult public func uploadSessionAppend(sessionId: String, offset: UInt64, input: URL) -> UploadRequest<
        VoidSerializer,
        Files.UploadSessionAppendErrorSerializer
    > {
        let route = Files.uploadSessionAppend
    ...
    /// `Files.UploadSessionAppendError` object on failure.
    @available(*, unavailable, message: "uploadSessionAppend is deprecated.")
    @discardableResult public func uploadSessionAppend(sessionId: String, offset: UInt64, input: InputStream) -> UploadRequest<
        VoidSerializer,
        Files.UploadSessionAppendErrorSerializer
    > {
        let route = Files.uploadSessionAppend
    ...
    /// - returns: Through the response callback, the caller will receive a `Void` object on success or a
    /// `Files.UploadSessionAppendError` object on failure.
    @discardableResult public func uploadSessionAppendV2(cursor: Files.UploadSessionCursor, close: Bool = false, contentHash: String? = nil, input: Data) -> UploadRequest<
        VoidSerializer,
        Files.UploadSessionAppendErrorSerializer
    > {
    ...
    /// - returns: Through the response callback, the caller will receive a `Void` object on success or a
    /// `Files.UploadSessionAppendError` object on failure.
    @discardableResult public func uploadSessionAppendV2(cursor: Files.UploadSessionCursor, close: Bool = false, contentHash: String? = nil, input: URL) -> UploadRequest<
        VoidSerializer,
        Files.UploadSessionAppendErrorSerializer
    > {
        let route = Files.uploadSessionAppendV2
    ...
    /// - returns: Through the response callback, the caller will receive a `Void` object on success or a
    /// `Files.UploadSessionAppendError` object on failure.
    @discardableResult public func uploadSessionAppendV2(cursor: Files.UploadSessionCursor, close: Bool = false, contentHash: String? = nil, input: InputStream) -> UploadRequest<
        VoidSerializer,
        Files.UploadSessionAppendErrorSerializer
    > {
        let route = Files.uploadSessionAppendV2
    ...
    @discardableResult public func uploadSessionAppendBatch(entries: [Files.UploadSessionAppendBatchArgEntry], contentHash: String? = nil, input: Data) -> UploadRequest<
        Files.UploadSessionAppendBatchResultSerializer,
        Files.UploadSessionAppendBatchErrorSerializer
    > {
    ...
    /// - returns: Through the response callback, the caller will receive a `Files.UploadSessionAppendBatchResult`
    /// object on success or a `Files.UploadSessionAppendBatchError` object on failure.
    @discardableResult public func uploadSessionAppendBatch(entries: [Files.UploadSessionAppendBatchArgEntry], contentHash: String? = nil, input: URL) -> UploadRequest<
        Files.UploadSessionAppendBatchResultSerializer,
        Files.UploadSessionAppendBatchErrorSerializer
    > {
        let route = Files.uploadSessionAppendBatch
    ...
    /// - returns: Through the response callback, the caller will receive a `Files.UploadSessionAppendBatchResult`
    /// object on success or a `Files.UploadSessionAppendBatchError` object on failure.
    @discardableResult public func uploadSessionAppendBatch(entries: [Files.UploadSessionAppendBatchArgEntry], contentHash: String? = nil, input: InputStream) -> UploadRequest<
        Files.UploadSessionAppendBatchResultSerializer,
        Files.UploadSessionAppendBatchErrorSerializer
    > {
        let route = Files.uploadSessionAppendBatch
    ...
    @discardableResult public func uploadSessionFinish(cursor: Files.UploadSessionCursor, commit: Files.CommitInfo, contentHash: String? = nil, input: Data) -> UploadRequest<
        Files.FileMetadataSerializer,
        Files.UploadSessionFinishErrorSerializer
    > {
    ...
    /// - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.UploadSessionFinishError` object on failure.
    @discardableResult public func uploadSessionFinish(cursor: Files.UploadSessionCursor, commit: Files.CommitInfo, contentHash: String? = nil, input: URL) -> UploadRequest<
        Files.FileMetadataSerializer,
        Files.UploadSessionFinishErrorSerializer
    > {
        let route = Files.uploadSessionFinish
    ...
    @discardableResult public func uploadSessionFinishBatch(entries: [Files.UploadSessionFinishArg]) -> RpcRequest<
        Files.UploadSessionFinishBatchLaunchSerializer,
        VoidSerializer
    > {
    ...
    /// object on success or a `Void` object on failure.
    @discardableResult public func uploadSessionFinishBatchV2(entries: [Files.UploadSessionFinishArg]) -> RpcRequest<
        Files.UploadSessionFinishBatchResultSerializer,
        VoidSerializer
    > {
    ...
    @discardableResult public func uploadSessionFinishBatchCheck(asyncJobId: String) -> RpcRequest<
        Files.UploadSessionFinishBatchJobStatusSerializer,
        Async.PollErrorSerializer
    > {
    ...
    @discardableResult public func uploadSessionStart(close: Bool = false, sessionType: Files.UploadSessionType? = nil, contentHash: String? = nil, input: Data) -> UploadRequest<
        Files.UploadSessionStartResultSerializer,
        Files.UploadSessionStartErrorSerializer
    > {
    ...
    /// - returns: Through the response callback, the caller will receive a `Files.UploadSessionStartResult` object on
    /// success or a `Files.UploadSessionStartError` object on failure.
    @discardableResult public func uploadSessionStart(close: Bool = false, sessionType: Files.UploadSessionType? = nil, contentHash: String? = nil, input: URL) -> UploadRequest<
        Files.UploadSessionStartResultSerializer,
        Files.UploadSessionStartErrorSerializer
    > {
        let route = Files.uploadSessionStart
    ...
    /// on success or a `Void` object on failure.
    @discardableResult public func uploadSessionStartBatch(numSessions: UInt64, sessionType: Files.UploadSessionType? = nil) -> RpcRequest<
        Files.UploadSessionStartBatchResultSerializer,
        VoidSerializer
    > {
