...
public class AuthAppAuthRoutes: DropboxTransportClientOwning {
    ...
    @discardableResult public func tokenFromOauth1(oauth1Token: String, oauth1TokenSecret: String) -> RpcRequest<
        Auth.TokenFromOAuth1ResultSerializer,
        Auth.TokenFromOAuth1ErrorSerializer
    > {
