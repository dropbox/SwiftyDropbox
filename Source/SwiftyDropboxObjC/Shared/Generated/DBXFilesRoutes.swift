...
public class DBXFilesRoutes: NSObject {
    ...
    @discardableResult public func listRevisions(
        path: String,
        mode: DBXFilesListRevisionsMode,
        limit: NSNumber,
        beforeRev: String?,
        includeRestorableInfo: NSNumber
    ) -> DBXFilesListRevisionsRpcRequest {
        let swift = swift.listRevisions(
            path: path,
            mode: mode.swift,
    ...
    /// success or a `Void` object on failure.
    @objc
    @discardableResult public func moveBatchV2(entries: [DBXFilesRelocationPath], autorename: NSNumber, allowOwnershipTransfer: NSNumber) -> DBXFilesMoveBatchRpcRequestV2 {
    ...
    @objc
    @discardableResult public func uploadSessionAppendBatchData(entries: [DBXFilesUploadSessionAppendBatchArgEntry], contentHash: String?, input: Data) -> DBXFilesUploadSessionAppendBatchUploadRequest {
        let swift = swift.uploadSessionAppendBatch(entries: entries.map(\.swift), contentHash: contentHash, input: input)
    ...
    /// object on success or a `Files.UploadSessionAppendBatchError` object on failure.
    @objc
    @discardableResult public func uploadSessionAppendBatchData(entries: [DBXFilesUploadSessionAppendBatchArgEntry], input: Data) -> DBXFilesUploadSessionAppendBatchUploadRequest {
        let swift = swift.uploadSessionAppendBatch(entries: entries.map(\.swift), input: input)
        return DBXFilesUploadSessionAppendBatchUploadRequest(swift: swift)
    }
    ...
    /// object on success or a `Files.UploadSessionAppendBatchError` object on failure.
    @objc
    @discardableResult public func uploadSessionAppendBatchURL(entries: [DBXFilesUploadSessionAppendBatchArgEntry], contentHash: String?, input: URL) -> DBXFilesUploadSessionAppendBatchUploadRequest {
        let swift = swift.uploadSessionAppendBatch(entries: entries.map(\.swift), contentHash: contentHash, input: input)
        return DBXFilesUploadSessionAppendBatchUploadRequest(swift: swift)
    }
    ...
    /// object on success or a `Files.UploadSessionAppendBatchError` object on failure.
    @objc
    @discardableResult public func uploadSessionAppendBatchURL(entries: [DBXFilesUploadSessionAppendBatchArgEntry], input: URL) -> DBXFilesUploadSessionAppendBatchUploadRequest {
        let swift = swift.uploadSessionAppendBatch(entries: entries.map(\.swift), input: input)
        return DBXFilesUploadSessionAppendBatchUploadRequest(swift: swift)
    }
    ...
    /// object on success or a `Files.UploadSessionAppendBatchError` object on failure.
    @objc
    @discardableResult public func uploadSessionAppendBatchInputStream(
        entries: [DBXFilesUploadSessionAppendBatchArgEntry],
        contentHash: String?,
        input: InputStream
    ) -> DBXFilesUploadSessionAppendBatchUploadRequest {
        let swift = swift.uploadSessionAppendBatch(entries: entries.map(\.swift), contentHash: contentHash, input: input)
        return DBXFilesUploadSessionAppendBatchUploadRequest(swift: swift)
    }
    ...
    /// object on success or a `Files.UploadSessionAppendBatchError` object on failure.
    @objc
    @discardableResult public func uploadSessionAppendBatchInputStream(entries: [DBXFilesUploadSessionAppendBatchArgEntry], input: InputStream) -> DBXFilesUploadSessionAppendBatchUploadRequest {
        let swift = swift.uploadSessionAppendBatch(entries: entries.map(\.swift), input: input)
        return DBXFilesUploadSessionAppendBatchUploadRequest(swift: swift)
    }
