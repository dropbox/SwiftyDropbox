...
public class DropboxClient : BabelClient {
    ...
    public init(accessToken: DropboxAccessToken, manager: Manager, backgroundManager: Manager, baseHosts: [String : String]) {
        self.accessToken = accessToken
        super.init(manager: manager, backgroundManager: backgroundManager, baseHosts: baseHosts)
