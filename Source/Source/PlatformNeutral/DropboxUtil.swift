...
public class Dropbox {
    ...
    static func setupWithAppKey(appKey: String, sharedAuthManager: DropboxAuthManager) {
        ...
        DropboxAuthManager.sharedAuthManager = sharedAuthManager
    ...
    static func setupWithTeamAppKey(appKey: String, sharedAuthManager: DropboxAuthManager) {
        precondition(DropboxAuthManager.sharedAuthManager == nil, "Only call `Dropbox.setupWithAppKey` or `Dropbox.setupWithTeamAppKey` once")
        DropboxAuthManager.sharedAuthManager = sharedAuthManager
